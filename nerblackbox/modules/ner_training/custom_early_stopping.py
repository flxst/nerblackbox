...
class CustomEarlyStopping(EarlyStopping):
    ...
    def __init__(self, lr_schedule: str, lr_cooldown_epochs: int, lr_cooldown_restarts: bool, *args, **kwargs):
        self.lr_schedule = lr_schedule
        self.lr_cooldown_epochs = lr_cooldown_epochs
        self.lr_cooldown_restarts = lr_cooldown_restarts
        super().__init__(*args, **kwargs)

        self.use_cooldown = self.lr_schedule == "constant" and self.lr_cooldown_epochs > 0
    ...
    def on_validation_end(self, trainer, pl_module):
        ...
        if self.use_cooldown:
            if self.wait_count == self.wait_count_trigger_cool_down:
                # NO IMPROVEMENT
                print(f"> Custom Early Stopping: change LR to linear cool-down with {self.lr_cooldown_epochs} epochs.")
            ...
            elif self.lr_cooldown_restarts and self.flag_cooldown is True and self.wait_count == 0:
