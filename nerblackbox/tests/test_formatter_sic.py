...
class TestSicFormatter:
    ...
    def test_read_original_file(self,
        ...
        assert test_sentences_rows == sentences_rows, \
    ...
    def test_transform_tags(self,
        ...
        assert test_transformed_tag == transformed_tag, f"ERROR! test_transformed_tag = {test_transformed_tag} != {transformed_tag}"
        ...
        [
            (
                    [
                        ...
                        pd.DataFrame(data=[["O PER", "Mening 3"]],
                                     index=pd.RangeIndex(2, 3)
                                     ),
                        pd.DataFrame(data=[["O PER", "Mening 4"]],
                                     index=pd.RangeIndex(3, 4)
                                     ),
                    ]
            ),
        ]
    ...
    def test_resplit_data(self,
        ...
        test_df_train, test_df_val, test_df_test = \
            self.formatter.resplit_data(val_fraction=val_fraction, write_csv=False)
