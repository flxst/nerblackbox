...
class TestExperimentResults:
    ...
    true_parameters_runs: Dict[Tuple[str, str], Any] = {
        ...
        ('metrics', 'EPOCH_BEST_VAL_ENTITY_FIL_F1_MICRO'): [0.7276507276507277, 0.7757575757575756],
        ('metrics', 'EPOCH_BEST_TEST_ENTITY_FIL_F1_MICRO'): [0.7388535031847134, 0.691358024691358],
        ('metrics', 'EPOCH_BEST_VAL_TOKEN_FIL_F1_MICRO'): [0.7879699248120301, 0.8240469208211143],
        ('metrics', 'EPOCH_BEST_TEST_TOKEN_FIL_F1_MICRO'): [0.7771260997067448, 0.7463976945244957],
        ('metrics', 'entity_fil_precision_micro'): [0.7981651376146789, 0.721030042918455],
        ('metrics', 'entity_fil_recall_micro'): [0.6877470355731226, 0.6640316205533597],
        ('metrics', 'entity_fil_asr_abidance'): [1.0, 1.0],
        ('metrics', 'entity_fil_asr_precision_micro'): [0.7981651376146789, 0.721030042918455],
    ...
    true_single_runs: pd.DataFrame = pd.DataFrame(
        {
            ...
            ('metrics', 'TEST_ENT_ASR_PRE'): {1: 0.721030042918455, 0: 0.7981651376146789},
            ('metrics', 'TEST_ENT_ASR_REC'): {1: 0.6640316205533597, 0: 0.6877470355731226},
            ('metrics', 'TEST_ENT_ASR_F1'): {1: 0.691358024691358, 0: 0.7388535031847134}
        }
    )
