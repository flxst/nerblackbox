...
class TestExperimentResults:
    ...
    true_parameters_runs_renamed_average: Dict[Tuple, Any] = {
        ...
        ('params', 'batch_sz'): ['16'],
        ('metrics', 'VAL_ENT_F1'): ['0.76248 +- 0.01129'],
        ('metrics', 'TEST_ENT_F1'):  ['0.71429 +- 0.00244'],
        ('metrics', 'VAL_TOK_F1'):   ['0.80927 +- 0.01105'],
        ('metrics', 'TEST_TOK_F1'):  ['0.75969 +- 0.00062'],
        ('metrics', 'TEST_ENT_PRE'): ['0.72748 +- 0.00356'],
        ('metrics', 'TEST_ENT_REC'): ['0.70158 +- 0.00140'],
    }
    ...
    true_average_runs: pd.DataFrame = pd.DataFrame(
        {
            ...
            ('metrics', 'VAL_ENT_F1'): {0: '0.76248 +- 0.01129'},
            ('metrics', 'TEST_ENT_F1'): {0: '0.71429 +- 0.00244'},
            ('metrics', 'VAL_TOK_F1'): {0: '0.80927 +- 0.01105'},
            ('metrics', 'TEST_TOK_F1'): {0: '0.75969 +- 0.00062'},
            ('metrics', 'TEST_ENT_PRE'): {0: '0.72748 +- 0.00356'},
            ('metrics', 'TEST_ENT_REC'): {0: '0.70158 +- 0.00140'},
        }
    )
    true_best_single_run: Dict = {
        ...
        'VAL_TOK_F1': 0.8248914616497828,
        'TEST_TOK_F1': 0.7605633802816902,
    ...
    true_best_average_run: Dict = {
        ...
        'exp_name': 'my_experiment_mlflow_runs',
        'run_name': 'runA',
        'VAL_TOK_F1': '0.80927 +- 0.01105',
        'TEST_TOK_F1': '0.75969 +- 0.00062',
        'VAL_ENT_F1': '0.76248 +- 0.01129',
        'TEST_ENT_F1': '0.71429 +- 0.00244',
        'TEST_ENT_PRE': '0.72748 +- 0.00356',
        'TEST_ENT_REC': '0.70158 +- 0.00140',
    }
