...
class TestExperiment:
    ...
    def test_create_info_for_runs(self,
        ...
        # 1. runs_name_nr
        assert self.experiment.runs_name_nr == runs_name_nr, \
            f"ERROR! self.experiment.runs_name_nr = {self.experiment.runs_name_nr} != {runs_name_nr}"

        # 2. runs_params
        assert sorted(list(self.experiment.runs_params.keys())) == sorted(list(runs_params.keys())), \
    ...
    def test_create_info_for_mlflow(self,
        ...
        if run_name_nr is None:
            ...
            test_params_and_hparams = self.experiment.params_and_hparams[get_run_name(run_name_nr)]
