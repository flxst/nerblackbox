...
class TestTextEncoder:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {"\n": "[NEWLINE]", "\t": "[TAB]"},
                ["an\n example"],
                [[{"char_start": "4", "char_end": "11", "token": "example", "tag": "TAG"}]],
                [[{"char_start": "12", "char_end": "19", "token": "example", "tag": "TAG"}]],
            ),
            ...
            (
                ...
                [[
                    {"char_start": "0", "char_end": "2", "token": "an", "tag": "O"},
                    {"char_start": "2", "char_end": "11", "token": "[NEWLINE]", "tag": "O"},
                    {"char_start": "12", "char_end": "19", "token": "example", "tag": "TAG"},
                ]],
            ),
        ],
    ...
    def tests(
        ...
        test_text_list, test_predictions_list = text_encoder.decode(text_encoded_list,
                                                                    encodings_list,
                                                                    predictions_encoded_list)
        assert test_text_list == text_list, \
            f"ERROR! test_text_list = {test_text_list} != text_list = {text_list}"
        assert test_predictions_list == predictions_list, \
