...
class TestNerModelPredictStatic:
    ...
    def test_restore_unknown_tokens(
        ...
        assert test_example_word_predictions_restored == example_word_predictions_restored, \
    ...
    def test_restore_annotatione_scheme_consistency(
        ...
        test_example_word_predictions_restored = \
            restore_annotation_scheme_consistency(example_word_predictions)
        assert test_example_word_predictions_restored == example_word_predictions_restored, \
            f"test_example_word_predictions_restored = " \
            f"{test_example_word_predictions_restored} != " \
            f"{example_word_predictions_restored}"
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                    ...
                    [
                        {"char_start": "0", "char_end": "18", "token": "arbetsförmedlingen", "tag": "ORG"},
                        {"char_start": "19", "char_end": "24", "token": "finns", "tag": "PER"},
                    ],
            ),
            (
                    [
                    ...
                    [
                        {"char_start": "0", "char_end": "18", "token": "arbetsförmedlingen", "tag": "ORG"},
                        {"char_start": "19", "char_end": "26", "token": "finns i", "tag": "PER"},
                        {"char_start": "27", "char_end": "36", "token": "stockholm", "tag": "PER"},
                    ],
            ),
        ],
    ...
    def test_merge_tokens_to_entities(
        ...
        test_example_word_predictions_merged = \
            merge_tokens_to_entities(example_word_predictions, example)
        assert test_example_word_predictions_merged == example_word_predictions_merged, \
